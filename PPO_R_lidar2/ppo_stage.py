...
def run(comm, env, policy, policy_path, action_bound, optimizer):
	...
	full_obs_stack = deque([full_obs, full_obs, full_obs, full_obs, full_obs])

        # get_state
        # obs = env.get_laser_observation()
        obs_stack = deque([full_obs_stack[0], full_obs_stack[2], full_obs_stack[4]])
...
if __name__ == '__main__':
    ...
    if rank == 0:
        ...
        file = policy_path + '/epi_25000.pth'
