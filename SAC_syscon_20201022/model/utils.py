...
def test_circle_init_pose(index):
    init_pose_list = [
        [0.00, 10.00, np.pi*26/25], 
        [0.00, -10.00, np.pi*27/25], 
        [8.0, 8.0, np.pi*28/25],
        [-8.0, -8.0, np.pi*29/25], 
        [8.0, -8.0, np.pi*30/25], 
        [-8.0, 8.0, np.pi*31/25], 
        [10.00, 0.00, np.pi*32/25],
        [-10.00, 0.00, np.pi*33/25]]

    return init_pose_list[index]

def test_circle_goal_point(index):
    goal_list = [
        [0.00, -10.00], 
        [0.00, 10.00], 
        [-8.0, -8.0],
