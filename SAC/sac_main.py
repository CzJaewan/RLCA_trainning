...
if __name__ == '__main__':
    ...
    reward = None
    if rank == 0:
        policy_path = '20_reward_goal_change_a10w5_epi_0'
        ...
        file_policy = policy_path + '/policy_epi_1500.pth'
        file_critic_1 = policy_path + '/critic_1_epi_1500.pth'
        file_critic_2 = policy_path + '/critic_2_epi_1500.pth'
