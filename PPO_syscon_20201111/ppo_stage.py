...
def run(comm, env, policy, policy_path, action_bound, optimizer):
    ...
    for id in range(MAX_EPISODES):
        ...
        if env.index == 0:
            writer.add_scalar('reward/train', ep_reward, id + 1 + 13026 + 2079 + 15360)
        ...
        if env.index == 0:
            ...
            if id != 0 and id % 500 == 0:
                ...
                writer.add_scalar('sec/train', compute_time_sec, id + 1 + 13026 + 2079 + 15360 )
                writer.add_scalar('nsec/train', compute_time_nsec, id + 1 + 13026 + 2079 + 15360)
...
if __name__ == '__main__':
    ...
    if not os.path.exists('./log/' + hostname + 'radius_test4'):
        os.makedirs('./log/' + hostname + 'radius_test4')
    output_file = './log/' + hostname + 'radius_test4' + '/output.log'
    cal_file = './log/' + hostname + 'radius_test4' + '/cal.log'
    ...
    if rank == 0:
        ...
        file = policy_path + '/epi_15000.pth'
